import { proReviewsController } from "../../src/controller";
import * as requestMock from '../../src/request/request.js';
import * as urlBuilderMock from '../../src/urlBuilder/proReviewsUrlBuilder.js';
import * as parserMock from '../../src/parser/proReviewsParser.js';

describe('Pro reviews controller tests', () => {
    ...
    it('Should return pro reviews object', async () => {
        const input = {id: 'XX'};
        const output = await proReviewsController(input);
